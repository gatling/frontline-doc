...
WARNING: link:https://jfrog.com/blog/into-the-sunset-bintray-jcenter-gocenter-and-chartcenter/[JFrog is terminating jCenter and Bintray services].
...
WARNING: gradle users are **strongly** recommended to upgrade to `frontline-gradle-plugin 1.3.4`.
...
WARNING: As announced for several months, we've finally turned down the `http://repository.gatling.io` maven repository.
...
WARNING: Runs and simulations API payloads have been modified: The field previously named `jvmProperties` has been renamed to `jvmOptions`.
...
WARNING: This release fixes several security issues (see DEV-726, DEV-747 and DEV-748).
...
* DEV-634: Some behavior change on the GCP API server causes a link:https://github.com/googleapis/google-api-java-client/issues/1060[Google Cloud Java SDK known bug] to happen way more frequently. We're implementing a workaround.
...
WARNING: Gatling 3.3.0 is source compatible but not fully binary compatible with the 3.2 series.
...
WARNING: This release introduce a major change in the way sources and binaries repositories and configured so such configuration is no longer duplicated in all your simulations.
...
WARNING: Make sure to check your Kubernetes pools setup as memory and cpu requests and limits are now mandatory.

WARNING: Please upgrade ASAP if you're using binary repositories, see DEV-543
...
WARNING: If you plan on deploying maven projects as fatjars in a maven repository, please upgrade `frontline-maven-plugin` to 1.0.3.
...
WARNING: Make sure to upgrade Gatling to 3.2.0, as version is not binary compatible with 3.1.3.

WARNING: This release ships important security improvements, so users are highly recommended to upgrade. In particular, Jenkins users are recommended to switch to Credentials for storing API tokens.

WARNING: <<deprecated, Some deprecated features>> have been removed.
...
WARNING: Make sure to upgrade Gatling to 3.1.3, as version is not binary compatible with 3.1.2.
...
WARNING: CI plugins must be upgraded to 1.6.2 too.
...
WARNING: Beware of the breaking change introduced in \#1844 in the public REST API:
...
WARNING: We now recommend you use latest Gatling OSS binaries (3.0.1 at the time of this release) instead of Gatling internal ones.
...
* link:https://gatling.io/docs/current/migration_guides/2.3-to-3.0/[migration guide] for hwo to upgrade. Most noticeable change for users coming from 1.4.7 is the case change of some DSL methods, eg `baseURL` becomes `baseUrl`.
...
* link:https://github.com/gatling/gatling/issues/3553[3553]: JsonPath shouldn't escape solidus
* link:https://github.com/gatling/gatling/issues/3554[3554]: Simulation folder points to resources one when launching Recorder from bundle
...
* link:https://github.com/gatling/gatling/issues/3105[3105]: Let users pass a custom check name
* link:https://github.com/gatling/gatling/issues/3408[3408]: Make actor system shutdown timeout configurable
* link:https://github.com/gatling/gatling/issues/3443[3443]: Result folder timestamp with sortable format
* link:https://github.com/gatling/gatling/issues/3476[3476]: Make checks with lots of possible actual values less verbose
* link:https://github.com/gatling/gatling/issues/3486[3486]: Make ConsoleDataWriter write interval configurable
* link:https://github.com/gatling/gatling/issues/3493[3493]: Maven plugin (3.0.0-M4): Support ant patterns in includes/excludes
* link:https://github.com/gatling/gatling/issues/3494[3494]: Have currentLocation expose url with fragment

==== Fixes

* link:https://github.com/gatling/gatling/issues/3473[3473]: Support single entry zip archives
* link:https://github.com/gatling/gatling/issues/3482[3482]: Fix http.perUserCacheMaxCapacity when set to 0
* link:https://github.com/gatling/gatling/issues/3485[3485]: Fix RampRateOpenInjection that wasn't always injecting the proper number
* link:https://github.com/gatling/gatling/issues/3487[3487]: Properly log response time when request crashes
* link:https://github.com/gatling/gatling/issues/3495[3495]: Maven plugin (3.0.0-M5): Properly honor zinc JVM args defaults
...
* link:https://github.com/gatling/gatling/issues/3445[3445]: JMS listener thread count can be configured

==== Fixes

* link:https://github.com/gatling/gatling/issues/3468[3468]: Protect against division by 0 when computing assertions with no requests
...
* link:https://github.com/gatling/gatling/issues/3436[3436]: Switch from Boon to Jodd as default JSON parser

==== Fixes

* link:https://github.com/gatling/gatling/issues/3437[3437]: Warmup request should set Connection header to close
